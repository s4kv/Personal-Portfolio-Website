...
def links_section():
    ...
    github_link = f'<a href="{info.my_github_url}"><img src="{info.github_image_url}" alt="Github" widht="65" height="65"></a>'
    st.sidebar.markdown(github_link, unsafe_allow_html=True)
    st.sidebar.text("Or email me!")
    email_html = f'<a href="mailto:{info.my_email_address}"><img src="{info.email_image_url}" alt="Email" widht="75" height="75"></a>'
...
def skills_section(programming_data, spoken_data):
    st.header("Skills")
    st.subheader("Programing Languages")
...
def activities_section(leadership_data, activity_data):
    ...
    tab1, tab2 = st.tabs(["Leadership & Activities", "Extra Courses"])
    with tab1:
